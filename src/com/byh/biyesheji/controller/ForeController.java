...
public class ForeController {
    ...
    public String createOrder( Model model,String address,HttpSession session) throws UnsupportedEncodingException{
        /*
...
//        address=new String(address);
    ...
    @ResponseBody
    public String cstPinglun(HttpSession session,int pid,String content) throws UnsupportedEncodingException{
        Customer cst = (Customer) session.getAttribute("cst");
